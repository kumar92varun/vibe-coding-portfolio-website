  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="relative">
      ...
      <footer class="bg-gray-100 text-gray-800 py-20">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-4 mt-2">
              ...
              <div class="flex flex-wrap gap-6">
                <a href="#" class="flex items-center gap-2 text-lg font-medium text-gray-700 hover:text-[#0A66C2] transition-colors group">
                ...
                <a href="#" class="flex items-center gap-2 text-lg font-medium text-gray-700 hover:text-[#E1306C] transition-colors group">
                ...
                <a href="#" class="flex items-center gap-2 text-lg font-medium text-gray-700 hover:text-[#FF0000] transition-colors group">
        ...
        <div class="text-center mt-12 pt-8 border-t border-gray-200 text-gray-500 font-medium">
          &copy; {{ new Date().getFullYear() }} Anshul. All rights reserved.
        </div>
      </footer>
    </div>
  </div>
